...
打造了一款智能车配置趋势分析工具，通过自动化采集行业竞品车型数据，结合智能分析模型，动态洞察智能配置的发展趋势，助力产品规划和战略决策。
"""
st.markdown(text_1)
st.write("")
st.write("")
...
"""
st.markdown(text_4)
data_overview = "assets/config_analysis/1.png"
...
"""
st.markdown(text_5)
data_distribution = "assets/config_analysis/2.png"
...
与业务方沟通，确定核心关注点为配置演进趋势与品牌选型差异，据此筛选出相关配置字段，聚焦辅助驾驶、感知硬件、座舱交互等模块。

"""
st.markdown(text_6)
config_seleciton = "assets/config_analysis/3.png"
st.image(config_seleciton)
st.write("")
...
"""
st.markdown(text_7)
config_seleciton = "assets/config_analysis/config_output.mp4"
st.video(config_seleciton) 
st.write("")
...
cols[1].page_link("pages/info_extract.py", label=":material/arrow_back_ios:  上一篇")
