...
cover = "assets/guguji/cover.png"
st.image(cover)

text_0 = """
#### 背景
最近迷上了一档名为 All-In with Chamath, Jason, Sacks & Friedberg 的播客节目，节目邀请行业资深人士，围绕经济、政治、科技、社会等多方面话题展开深度探讨。每期播客时长都超过一小时，对我来说既是享受，也是挑战。很多地方我听不太懂，尤其是俚语和玩笑部分。为了更好地理解播客内容，我希望能将播客转写成文本。
"""
st.markdown(text_0)
st.write("")
st.write("")
...
"""
st.markdown(text_1)
competitive_analysis = ["assets/guguji/1.png",
                        "assets/guguji/2.png",
                        "assets/guguji/3.png",
                        "assets/guguji/4.png",
                        "assets/guguji/5.png"]

for image in competitive_analysis:
    st.image(image)

text_2 = """
我想要有一个能帮助我**渐进式理解播客内容**的工具，理想的使用流程是：
...
- **NotebookLM：** 模型能力很强，摘要和结构化笔记重点明确且自带引用，但交互复杂，不支持音频与文本联动，不能边听边看，而且上传音频有 200M 限制，无法处理多数 2 小时以上的播客。
...
"""
st.markdown(text_4)
speaker_diarization_flow = "assets/guguji/6.png"
st.image(speaker_diarization_flow)
...
- **3D speaker**
    ...
    代码中部分模块（如语音分割、重叠检测）依赖于 pyannote/segmentation-3.0。虽然提供了较完整的端到端说话人分离推理脚本 infer_diarization.py，便于命令行快速调用，但缺乏模块化封装，不适合直接在项目中灵活嵌入。
...
"""
st.markdown(text_9)
summarize_analysis = "assets/guguji/7.png"
st.image(summarize_analysis)
...
"""
st.markdown(text_11)
notes_anaysis = "assets/guguji/8.png"
st.image(notes_anaysis)
...
**Logo：** 结合钢笔、小鸡脑袋和声波的形状，用Figma简单绘制了个Logo（见右图）。
"""

logo = "assets/guguji/11.png"
...
st.write("")
st.markdown("##### 交互原型")
prototype = "assets/guguji/9.png"
st.image(prototype)
st.write("")

st.markdown("##### Demo展示")
demo = "assets/guguji/guguji.mp4"
st.video(demo)
